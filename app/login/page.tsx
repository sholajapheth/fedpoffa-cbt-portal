    ...
    <div className="min-h-screen bg-gradient-to-br from-fedpoffa-purple/10 via-fedpoffa-orange/5 to-fedpoffa-green/10 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in to your FEDPOFFA CBT Portal account</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-sm text-fedpoffa-purple hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/register" className="text-fedpoffa-purple hover:underline font-medium">
                Register here
              </Link>
            </p>
          </div>
